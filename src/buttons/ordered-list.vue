...
<script lang="ts">
    ...
    export default class OrderedList extends Vue {
        ...
        public activate () : void {
            ...
            this.iframe.contentWindow.document.execCommand('insertOrderedList');
        ...
        mounted () : void {
            this.$root.$on('mon-iframe-changed',  () => {
                if (this.iframe) {
                    this.buttonActivated = this.iframe.contentWindow.document.queryCommandState('insertOrderedList');
                }
            });
        }
    }
