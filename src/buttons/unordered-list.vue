...
<script lang="ts">
    ...
    export default class UnorderedList extends Vue {
        ...
        public activate () : void {
            ...
            this.iframe.contentWindow.document.execCommand('insertUnorderedList');
        ...
        mounted () : void {
            this.$root.$on('mon-iframe-changed',  () => {
                if (this.iframe) {
                    this.buttonActivated = this.iframe.contentWindow.document.queryCommandState('insertUnorderedList');
                }
            });
        }
    }
