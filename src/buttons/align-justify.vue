...
<script lang="ts">
    ...
    export default class AlignJustify extends Vue {
        ...
        public activate () : void {
            ...
            this.iframe.contentWindow.document.execCommand('justifyFull');
        ...
        mounted () : void {
            this.$root.$on('mon-iframe-changed',  () => {
                if (this.iframe) {
                    this.buttonActivated = this.iframe.contentWindow.document.queryCommandState('justifyFull');
                }
            });
        }
    }
